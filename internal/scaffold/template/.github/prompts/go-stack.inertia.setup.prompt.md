---
name: go-stack.inertia.setup
description: Instructions to setup the go-stack Inertia.js integration for fullstack Go applications, including boot provider wiring and frontend workflow.
---
